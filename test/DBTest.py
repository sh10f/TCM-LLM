...
data = []
with open("../dataset/Merge/CMB.json", "r", encoding="UTF-8") as f:
    data.extend(json.load(f))
    print("After CMB data: ", len(data))

with open("../dataset/Merge/CMExam.json", "r", encoding="UTF-8") as f:
    data.extend(json.load(f))
    print("After CMExam data: ", len(data))

with open("../dataset/Merge/MLEC-QA.json", "r", encoding="UTF-8") as f:
    data.extend(json.load(f))
    print("After MLEC-QA data: ", len(data))

with open("../dataset/Merge/TCMChat.json", "r", encoding="UTF-8") as f:
    data.extend(json.load(f))
    print("After TCMChat data: ", len(data))
